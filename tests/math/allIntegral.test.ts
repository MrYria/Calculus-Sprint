...
import { ALL_INTEGRAL_GENERATORS } from '../../src/math/integrals/index';

describe('Integrals Module Quality & Stress Test', () => {
  ALL_INTEGRAL_GENERATORS.forEach((gen) => {
